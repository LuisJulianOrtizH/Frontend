function autoTraeCategoria(){
    ...
    $.ajax({
        url:"http://152.67.40.3:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function cargarDatosPartyroom(id) {
    $.ajax({
        dataType: 'json',
        url:"http://152.67.40.3:8080/api/Partyroom/"+id,
    ...
    if($("#namesalones").val().length == 0 || $("#owner").val().length == 0 || $("#capacity").val().length == 0 || $("#descriptionsalones").val().length == 0){
       alert("Todos los campos son obligatorios")
            ...
            $.ajax({
                ...
                url:"http://152.67.40.3:8080/api/Partyroom/save",
                data: dataToSend,
                datatype: 'json',
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url:"http://152.67.40.3:8080/api/Partyroom/"+idElemento,
            type: 'DELETE',
            contentType: "application/JSON",
            success: function (response) {
                console.log(response);
...
function actualizar(idElemento) {
    ...
    if($("#namesalones").val().length == 0 || $("#owner").val().length == 0 || $("#capacity").val().length == 0 || $("#descriptionsalones").val().length == 0){
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url:"http://152.67.40.3:8080/api/Partyroom/update",
